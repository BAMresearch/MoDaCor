...
When `reporting a bug <https://github.com/BAMresearch/MoDaCor/issues>`_ please include:
...
MoDaCor could always use more documentation, whether as part of the
official MoDaCor docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork `MoDaCor <https://github.com/BAMresearch/MoDaCor>`_
