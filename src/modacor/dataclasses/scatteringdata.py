...
class ScatteringData:
    """
    ScatteringData is a specialized data class for storing and processing scattering data.
    It inherits from the BaseData class and adds additional attributes specific to scattering experiments.
    """
