...
Please follow the code practices of the project, and consider making your modules available to the wider world. This will be considered if modules have the standard header, use ProcessStepDescriber to describe the module, and have tests in the corresponding directory in tests/modules/instrument_modules/...
